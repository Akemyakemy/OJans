...
#include<bits/stdc++.h>
using namespace std;
#define boost cin.tie(nullptr) -> sync_with_stdio(false),cout.flush();
#define int int64_t
...
#else
	int a=read(),b=read();
	if(__builtin_clz(a)>__builtin_clz(b)) printf("-1\n");
