// Problem: Array Deletion Game
// Contest: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/108302/C
...
#ifdef brute
	int n=read();
    a.resize(n);presum.resize(n+1,0);
    for(int i=0;i<n;i++) {
        a[i]=read();
